...
import { selectedItemLimit, removeSelectedItems, removeAllSelctedIds } from "../../Redux/Actions/appAction";
            ...
            ? allProducts.products.map((el) => (
                 <>
                    <inner.tr className={variation ? "padding_table" : null} variation={variation ? variation : null}>
                       ...
                       <inner.td>{el?.brand ? el.brand.name : <div>No Brand</div>}</inner.td>
                       <inner.td>{el?.category ? el.category.name : <div>Uncategory</div>}</inner.td>
                       <inner.td>
                          {el?.createdAt
                             ? (function () {
