...
import { productTagsFetchLoading } from '../../Redux/Actions/adminAppAction';
...
function AllProductsTagsComponent() {
   ...
   return (
      <tags.div>
         ...
         <tags.spaceDiv>
            <ProductSectionFeatureComponent state={allProductsTags} pageLink={link} field={'tags'} items={items} action={deleteAllTags} />
            <AllProductsTagsTableComponent />
            <TableFooterComponent state={allProductsTags} action={'tags'} eventHandler={getProductTags} eventLoading={productTagsFetchLoading(true)} />
         </tags.spaceDiv>
      </tags.div>
   );
}
