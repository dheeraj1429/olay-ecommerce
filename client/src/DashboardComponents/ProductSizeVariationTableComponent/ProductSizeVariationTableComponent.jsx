...
function ProductSizeVariationTableComponent() {
   ...
   return (
      <size.div>
         ...
         <size.spaceDiv>
            <ProductSectionFeatureComponent state={allSizeVariations} pageLink={link} field={"sizeVariations"} items={items} action={removeAllProductSizeVaration} />

            <AllSwatchTableComponent color={false} variation={allSizeVariations} row={row} field={"sizeVariations"} />
         </size.spaceDiv>
      </size.div>
   );
}
