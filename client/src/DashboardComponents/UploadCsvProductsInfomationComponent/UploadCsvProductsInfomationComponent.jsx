...
import { showProductInfoCom } from '../../Redux/Actions/adminAppAction';
   ...
   return ReactDOM.createPortal(
      <styled.mainDiv show={show}>
         <styled.innerDiv show={show}>
            ...
            <styled.spaceDiv>
               <UploadCsvProductsInfoComponent
                  Heading={'Product uploaded'}
                  target={'insertDocuments'}
                  icon={<FcApproval />}
               />
               <UploadCsvProductsInfoComponent
                  Heading={'Product brand uploded'}
                  target={'brandsInserted'}
                  icon={<FcApproval />}
               />
               <UploadCsvProductsInfoComponent
                  Heading={'Product category uploded'}
                  target={'categoryinserted'}
                  icon={<FcApproval />}
               />
               <UploadCsvProductsInfoComponent
                  Heading={'Product skip'}
                  target={'skipDocuments'}
                  icon={<FcHighPriority />}
                  skip={true}
               />
               <UploadCsvProductsInfoComponent
                  Heading={'Product brand skip'}
                  target={'brandsSkiped'}
                  icon={<FcHighPriority />}
                  skip={true}
               />
               <UploadCsvProductsInfoComponent
                  Heading={'Product category skip'}
                  target={'categorySkiped'}
                  icon={<FcHighPriority />}
                  skip={true}
               />
            </styled.spaceDiv>
