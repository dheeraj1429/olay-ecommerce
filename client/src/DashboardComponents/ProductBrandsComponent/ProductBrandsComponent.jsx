...
import { deleteAllBrand, deleteMultiSelectedProductBrand, fetchAllProductBrand } from '../../Redux/Actions/adminAction';
...
import { fetchBrandProductLoading } from '../../Redux/Actions/adminAppAction';
      ...
      <brand.div>
         ...
         <brand.innerDiv>
            ...
            <TableFooterComponent
               action={'brands'}
               state={productBrands}
               eventHandler={fetchAllProductBrand}
               eventLoading={fetchBrandProductLoading(true)}
               multiDeletHandler={deleteMultiSelectedProductBrand}
            />
         </brand.innerDiv>
      </brand.div>
   );
